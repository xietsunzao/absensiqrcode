$(document).ready(function() {
    ...
    $("body").on("change", ".is_parent", function(e) {
        ...
        $('input:checkbox.is_child[data-parent-id="' + parent_id + '"]').not(this).not(":disabled").prop('checked', this.checked);
        $('input:checkbox.permission[data-parent-id="' + parent_id + '"]').not(this).not(":disabled").prop('checked', this.checked);
    });
